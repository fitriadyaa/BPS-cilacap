...
import 'package:bps_cilacap/homescreen_menu/inflasi/body_seriesbulanan.dart';
import 'package:flutter/material.dart';

class SeriesBulanan extends StatefulWidget {
  const SeriesBulanan({super.key});

  @override
  State<SeriesBulanan> createState() => _SeriesBulanan();
}

class _SeriesBulanan extends State<SeriesBulanan> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "SERIES IHK & INFLASI 3 BULAN TERAKHIR",
          ...
          children: [
            Container(
              ...
              child: const Center(
                child: Padding(
                  ...
                  child: Text(
                    "IHK dan Inflasi Kota Cilacap 3 (tiga) Bulan Terakhir, Menurut Kelompok Pengeluaran",
            ...
            Flexible(
              child: SizedBox(
                ...
                child: const BodySeriesInflasiBulanan(),
              ),
            ),
          ],
        ),
