...
import 'package:bps_cilacap/homescreen_menu/inflasi/body_serieskota.dart';
import 'package:flutter/material.dart';

class SeriesInflasiKota extends StatefulWidget {
  const SeriesInflasiKota({super.key});

  @override
  State<SeriesInflasiKota> createState() => _SeriesInflasiKota();
}

class _SeriesInflasiKota extends State<SeriesInflasiKota> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "SERIES IHK & INFLASI 9 KOTA DI JAWA TENGAH",
        ...
        child: Column(
          children: [
            Container(
              ...
              child: const Center(
                child: Padding(
                  ...
                  child: Text(
                    "Inflasi 9 (Sembilan) Kota Di Jawa Tengah Dalam 3 (tiga) Bulan Terakhir",
            ...
            Flexible(
              child: SizedBox(
                height: screenHeight,
                child: const BodySeriesInflasiKota(),
              ),
            ),
          ],
        ),
