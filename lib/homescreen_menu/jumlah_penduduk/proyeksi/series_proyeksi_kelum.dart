...
import 'package:bps_cilacap/homescreen_menu/jumlah_penduduk/proyeksi/body_series_kelum.dart';
import 'package:flutter/material.dart';

class SeriesProyeksiKelum extends StatefulWidget {
  const SeriesProyeksiKelum({super.key});

  @override
  State<SeriesProyeksiKelum> createState() => _SeriesProyeksiKelum();
}

class _SeriesProyeksiKelum extends State<SeriesProyeksiKelum> {
  @override
          ...
          children: [
            Container(
              ...
              child: const Center(
                child: Padding(
                  ...
                  child: Text(
                    "Penduduk Kabupaten Cilacap Menurut Kelompok Umur (Hasil Proyeksi Penduduk)",
            ...
            Flexible(
              child: SizedBox(
                ...
                child: const BodySeriesProyeksiKelum(),
              ),
            ),
          ],
        ),
