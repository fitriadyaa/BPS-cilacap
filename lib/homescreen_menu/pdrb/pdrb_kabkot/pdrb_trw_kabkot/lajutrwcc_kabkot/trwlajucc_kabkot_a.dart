...
void main() => runApp(const TrwlajuccKabkotA());

class TrwlajuccKabkotA extends StatelessWidget {
  const TrwlajuccKabkotA({super.key});
...
Future<List<Data>> fetchData() async {
  var url = Uri.parse('https://bps-3301-asap.my.id/api/trwlajucc-kabkot');
