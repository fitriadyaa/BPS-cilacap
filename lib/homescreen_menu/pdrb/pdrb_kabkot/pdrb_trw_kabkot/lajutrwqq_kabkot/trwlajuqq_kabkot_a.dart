...
void main() => runApp(const TrwlajuqqKabkotA());

class TrwlajuqqKabkotA extends StatelessWidget {
  const TrwlajuqqKabkotA({super.key});
...
class Data {
  ...
  final String trw1_n1;
  final String trw2_n1;
  final String trw3_n1;
  final String trw4_n1;
  ...
  Data(
      ...
      required this.trw1_n1,
      required this.trw2_n1,
      required this.trw3_n1,
      required this.trw4_n1,
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      ...
      trw1_n1: json['trw1_n1'],
      trw2_n1: json['trw2_n1'],
      trw3_n1: json['trw3_n1'],
      trw4_n1: json['trw4_n1'],
