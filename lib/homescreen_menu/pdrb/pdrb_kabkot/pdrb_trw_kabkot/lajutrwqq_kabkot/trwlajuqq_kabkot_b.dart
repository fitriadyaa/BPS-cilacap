...
void main() => runApp(const TrwlajuqqKabkotB());

class TrwlajuqqKabkotB extends StatelessWidget {
  const TrwlajuqqKabkotB({super.key});
...
class Data {
  ...
  final String trw1_n2;
  final String trw2_n2;
  final String trw3_n2;
  final String trw4_n2;
  ...
  Data(
      ...
      required this.trw1_n2,
      required this.trw2_n2,
      required this.trw3_n2,
      required this.trw4_n2,
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      ...
      trw1_n2: json['trw1_n2'],
      trw2_n2: json['trw2_n2'],
      trw3_n2: json['trw3_n2'],
      trw4_n2: json['trw4_n2'],
