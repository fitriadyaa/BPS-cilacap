...
void main() => runApp(const TrwlajuqqKabkotC());

class TrwlajuqqKabkotC extends StatelessWidget {
  const TrwlajuqqKabkotC({super.key});
...
Future<List<Data>> fetchData() async {
  var url = Uri.parse('https://bps-3301-asap.my.id/api/trwlajuqq-kabkot');
...
class Data {
  ...
  final String trw1_n3;
  final String trw2_n3;
  final String trw3_n3;
  final String trw4_n3;
  ...
  Data(
      ...
      required this.trw1_n3,
      required this.trw2_n3,
      required this.trw3_n3,
      required this.trw4_n3,
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      ...
      trw1_n3: json['trw1_n3'],
      trw2_n3: json['trw2_n3'],
      trw3_n3: json['trw3_n3'],
      trw4_n3: json['trw4_n3'],
