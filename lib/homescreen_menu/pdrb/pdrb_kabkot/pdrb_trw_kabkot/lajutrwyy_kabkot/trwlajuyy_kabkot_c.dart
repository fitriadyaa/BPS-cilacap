...
void main() => runApp(const TrwlajuyyKabkotC());

class TrwlajuyyKabkotC extends StatelessWidget {
  const TrwlajuyyKabkotC({super.key});
...
Future<List<Data>> fetchData() async {
  var url = Uri.parse('https://bps-3301-asap.my.id/api/trwlajuyy-kabkot');
